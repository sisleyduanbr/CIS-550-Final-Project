...
export default function SongCard({ songId, handleClose }) {
  ...
  // DONE (TASK 20): fetch the song specified in songId and based on the fetched album_id also fetch the album data
  ...
  const radarData = [
    { subject: 'Danceability', value: songData.danceability },
    { subject: 'Energy', value: songData.energy},
    { subject: 'Valence', value: songData.valence},
  ];
          ...
          { // This ternary statement returns a BarChart if barRadar is true, and a RadarChart otherwise
            barRadar
              ? (
                ...
                <ResponsiveContainer height={250}>
                  {/* DONE (TASK 21): display the same data as the bar chart using a radar chart */}
