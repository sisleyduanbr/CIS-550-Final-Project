...
export default function HomePage() {
  ...
  // DONE (TASK 13): add a state variable to store the app author (default to '')
  ...
  useEffect(() => {
    ...
    // DONE (TASK 14): add a fetch call to get the app author (name not pennkey) and store it in the state variable
  ...
  //  define the columns for the top albums (schema is Album Title, Plays), where Album Title is a link to the album page
  ...
  return (
    <Container>
      ...
      <Divider />
      {/* DONE (TASK 16): add a h2 heading, LazyTable, and divider for top albums. Set the LazyTable's props for defaultPageSize to 5 and rowsPerPageOptions to [5, 10] */}
      <h2>Top Albums</h2>
      ...
      {/* DONE (TASK 17): add a paragraph (<p>text</p>) that displays the value of your author state variable from TASK 13 */}
      <p>{author}</p>
    </Container>
  );
};